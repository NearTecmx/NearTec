...
for (const term of ['sales-galaxy','lead-filter-visual','solution-visual','conversion-funnel-visual','section-separated','solution-card-v2','flow-rail','lead-card']) if (!css.includes(term)) throw new Error(`CSS no contiene ${term}`)
...
console.log('Smoke test OK: V4.3 visual sales system, rutas, copy comercial, contacto, landing y API validadas.')
