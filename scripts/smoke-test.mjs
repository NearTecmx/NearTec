...
for (const term of ['hero-sales-scene','landing-sales-scene','sales-funnel-scene','service-hero-visual','section-separated','solution-card-v2','lead-card']) if (!css.includes(term)) throw new Error(`CSS no contiene ${term}`)
...
console.log('Smoke test OK: V4.4 visual premium, copy vendedor, rutas, contacto, landing y API validadas.')
