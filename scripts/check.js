import fs from 'fs';
const release='NEARTEC-FINAL-RENDER-LIGHT-TRUE-SCENE-2026-R3-BG4';
const cssName='neartec-final-render-light-true-scene-2026-r3-bg4.css';
const jsName='neartec-final-render-light-true-scene-2026-r3-bg4.js';
...
for(const file of ['assets/css/neartec-final-render-light-true-scene-2026-r3-bg4.css','assets/js/neartec-final-render-light-true-scene-2026-r3-bg4.js','api/health.js','vercel.json','package.json']){
