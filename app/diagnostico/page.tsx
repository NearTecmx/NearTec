...
export const metadata = {
  title: 'Diagnóstico NearTec',
  description: 'Descubre qué solución te conviene implementar primero para captar, atender y operar mejor.',
}
        ...
        <div className="container landing-grid">
          <div>
            ...
            <div className="hero-actions">
              <a className="btn btn-green" href="#aplicar">Aplicar ahora</a>
              <a className="btn btn-outline" href={`https://wa.me/${CONTACT.whatsappNumber}`}>
                WhatsApp {CONTACT.phoneDisplay}
              </a>
            </div>
            <div className="landing-proof">
              <span>Recomendación simple</span>
              <span>Orientación rápida</span>
              <span>Ruta inicial clara</span>
            </div>
          </div>
      ...
      <section className="section section-separated">
        <div className="container conversion-grid">
          <div className="conversion-card">
            <span>01</span>
            <b>Vemos dónde se atoran tus ventas</b>
            <p>Sitio, formularios, respuesta comercial, operación o continuidad.</p>
          </div>
          <div className="conversion-card">
            <span>02</span>
            <b>Te explicamos qué te conviene</b>
            <p>Sin lenguaje técnico innecesario y con pasos entendibles.</p>
          </div>
          <div className="conversion-card">
            <span>03</span>
            <b>Avanzas a cotización o contacto</b>
            <p>Con una base más clara para decidir y comprar mejor.</p>
          </div>
        </div>
      </section>
