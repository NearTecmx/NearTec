...
const logos = [
  {
    ...
    alt: 'Cliente corporativo destacado de NearTec',
    ...
    <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="client-proof-panel cinematic-reveal delay-2">
        <div className="client-proof-panel__copy">
          <span className="nt-badge nt-badge--soft">Señal de confianza</span>
          <h2 className="client-proof-panel__title">Marcas que ya han confiado en el ecosistema NearTec.</h2>
          <p className="client-proof-panel__text">
            No se trata de poner logos por adorno. Se trata de demostrar que ya existe
            trabajo real detrás de diseño web, operación, automatización y soluciones digitales.
          </p>
        </div>
