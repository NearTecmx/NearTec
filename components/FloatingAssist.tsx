  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: id(),
      role: 'bot',
      text: 'Soy Neary AI. Te ayudo a ubicar si necesitas web, apps, automatización, CRM, IA, CompuNegocio, CN7, nube, soporte o desarrollo tecnológico a medida.',
    },
  ])
  ...
  const wa = useMemo(
    () =>
      `https://wa.me/${CONTACT.whatsappNumber}?text=${encodeURIComponent(
        'Hola NearTec, quiero diagnóstico o cotización para un proyecto tecnológico.'
      )}`,
    []
  )
