      ...
      <div className="relative z-10 grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-[28px] border border-white/70 bg-white/95 p-4 shadow-[0_20px_40px_rgba(15,17,21,0.08)] backdrop-blur">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">NearTec ecosystem</p>
              <h3 className="mt-2 text-xl font-black text-[#0f1115]">Growth, operación y control conectados</h3>
            </div>
          ...
          <div className="mt-5 rounded-[26px] border border-[#e7edd8] bg-[#f9fbf4] p-4">
            <div className="flex items-center justify-between">
              <p className="text-[12px] font-bold uppercase tracking-[0.15em] text-[#67717a]">Panel vivo</p>
            ...
            <div className="mt-4 grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
              ...
              <div className="rounded-2xl border border-[#e7edd8] bg-white p-3 shadow-sm">
                <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#67717a]">Módulos activos</p>
        ...
        <div className="grid gap-4">
          <div className="relative overflow-hidden rounded-[28px] border border-[#e2e7da] bg-[#0f1115] p-4 text-white shadow-[0_24px_46px_rgba(15,17,21,0.24)]">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-4 flex items-center justify-between gap-4">
                {['Diagnóstico', 'Demo', 'Implementación'].map((item, index) => (
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-[#dce8bf] bg-white p-4 shadow-[0_20px_40px_rgba(15,17,21,0.08)]">
            ...
            <div className="relative z-10 grid gap-4 sm:grid-cols-[1fr_1fr]">
              <div>
                <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">Mapa operativo</p>
              ...
              <div>
                <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">Señales de compra</p>
                <div className="mt-4 rounded-[24px] border border-[#edf2df] bg-[#f9fbf4] p-4">
                  <BarSeries heights={[25, 38, 31, 57, 45, 74, 86]} />
                  <div className="mt-4 space-y-2">
                    {['Interés alto', 'Listo para demo', 'Requiere propuesta'].map((item) => (
  ...
  return (
    <div className="overflow-hidden rounded-[30px] border border-[#dce8bf] bg-white p-4 shadow-[0_24px_60px_rgba(15,17,21,0.08)] sm:p-5">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">Visibilidad operativa</p>
          <h3 className="mt-2 text-2xl font-black text-[#0f1115]">Métricas que sí guían decisiones</h3>
        </div>
        <span className="rounded-full bg-[#eef7d7] px-3 py-1 text-[11px] font-black uppercase tracking-[0.16em] text-[#0f1115]">Tiempo real</span>
      </div>
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[26px] border border-[#edf2df] bg-[#f9fbf4] p-4">
          <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">Gráfica dinámica</p>
        ...
        <div className="rounded-[26px] border border-[#edf2df] bg-[#0f1115] p-4 text-white shadow-[0_18px_40px_rgba(15,17,21,0.22)]">
          <p className="text-[11px] font-black uppercase tracking-[0.16em] text-white/60">Mapa de nodos</p>
...
export function NearTecFlowMockup() {
  return (
    <div className="overflow-hidden rounded-[30px] border border-[#dce8bf] bg-white p-5 shadow-[0_24px_60px_rgba(15,17,21,0.08)]">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">Ruta conectada</p>
          <h3 className="mt-2 text-2xl font-black text-[#0f1115]">Así viaja un lead hasta convertirse en operación</h3>
        </div>
      ...
      <div className="relative mt-6 grid gap-4 lg:grid-cols-5">
        {[
          ['Atracción', 'Sitio / campaña'],
          ['Filtro', 'Diagnóstico / chat'],
          ['Clasificación', 'Score / prioridad'],
          ['Seguimiento', 'CRM / WhatsApp'],
          ['Cierre', 'Demo / propuesta'],
      ...
      <div className="rounded-[28px] border border-[#e7edd8] bg-[linear-gradient(180deg,#ffffff_0%,#f7faef_100%)] p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h3 className="mt-2 text-xl font-black text-[#0f1115]">Secuencias más entendibles, visibles y medibles</h3>
          </div>
    ...
    <div className="overflow-hidden rounded-[30px] border border-[#dce8bf] bg-white p-4 shadow-[0_24px_60px_rgba(15,17,21,0.08)]">
      <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-[26px] border border-[#e7edd8] bg-[#f9fbf4] p-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#67717a]">Pipeline comercial</p>
              <h3 className="mt-2 text-xl font-black text-[#0f1115]">Lead filtering, priorización y agenda</h3>
            </div>
        ...
        <div className="rounded-[26px] border border-[#e7edd8] bg-[#0f1115] p-4 text-white shadow-[0_20px_40px_rgba(15,17,21,0.22)]">
          ...
          <div className="mt-4 space-y-3">
            {['Captura inteligente', 'Clasificación automática', 'Asignación al asesor', 'Agenda y remarketing'].map((item, index) => (
    ...
    <div className="overflow-hidden rounded-[34px] border border-[#dce8bf] bg-[linear-gradient(180deg,#ffffff_0%,#f7faef_100%)] p-4 shadow-[0_24px_60px_rgba(15,17,21,0.1)] sm:p-5">
      <div className="grid gap-4 lg:grid-cols-[0.98fr_1.02fr]">
        ...
        <div className="rounded-[28px] border border-[#e7edd8] bg-[#0f1115] p-4 text-white shadow-[0_20px_40px_rgba(15,17,21,0.22)]">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.16em] text-white/60">Mapa operativo</p>
