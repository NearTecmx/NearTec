      ...
      <div className="container">
        <div className="nav-inner">
          ...
          <div className="nav-cta">
            <a className="btn btn-outline" href={CONTACT.phoneHref}>Llamar</a>
            <Link className="btn btn-green" href="/cotizador">Cotizar</Link>
          </div>
        ...
        {open && <div className="mobile-menu">
          ...
          <Link href="/landing" onClick={()=>setOpen(false)}>Landing</Link>
          <Link href="/cotizador" onClick={()=>setOpen(false)}>Cotizador</Link>
          <a href={`https://wa.me/${CONTACT.whatsappNumber}`} onClick={()=>setOpen(false)}>WhatsApp</a>
        </div>}
      </div>
    </header>
  )
